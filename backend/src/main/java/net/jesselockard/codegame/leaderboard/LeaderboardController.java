...
public class LeaderboardController {
	...
	@Autowired LeaderboardRepository lbRepository;
	...
	List<Object> getLeaderboard(@RequestHeader(value="Authorization") String JWTUserToken) {
		...
		if(decodedToken != null) {
			...
			if(!userBoards.isEmpty()) {
				...
				leaderboardResponse.add("There are no records to display.");
			}
		}
			 ...
			 * inform the frontend there was an error trying to authenticate the token.
			 */
			leaderboardResponse.add("There was an error authenticating the user's token.");
			return leaderboardResponse;
		}
	...
	Map<String, Object> postUserLeaderboard(@RequestHeader(value="Authorization") String JWTUserToken, @RequestBody LeaderboardPutRequest leaderboardData) {
		String token = JWTUserToken.replace("Bearer ", "");
